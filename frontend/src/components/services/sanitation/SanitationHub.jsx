  ...
  const services = [
    {
      ...
      path: '/sanitation/toilet-construction',
    },
    {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-neutral">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/90 text-lg">Sanitation & Waste Management</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <h3 className="text-lg font-bold text-green-900 mb-2">Swachh Bharat Mission</h3>
          <p className="text-green-800">
            Get financial assistance for household toilet construction under Swachh Bharat Mission. 
            Subsidy up to ₹12,000 available for eligible households.
          </p>
        </motion.div>
      </main>
